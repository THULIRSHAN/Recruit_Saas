...
import { BriefcaseIcon, BuildingIcon, Card, EmptyState, InboxIcon, ListIcon, StatCard } from '@/components/ui';
    ...
    <div className="mx-auto flex w-full max-w-[1000px] gap-8 px-10 py-9">
      <div className="flex-1">
        ...
        <div className="grid grid-cols-2 gap-4">
          <StatCard label="Organizations" value={analytics?.organizations.total ?? 0} icon={<BuildingIcon size={15} />} tone="accent" />
          <StatCard
            ...
            tone="success"
          />
          <StatCard label="Jobs posted" value={analytics?.jobs.total ?? 0} icon={<BriefcaseIcon size={15} />} tone="info" />
          <StatCard label="Applications" value={analytics?.applications.total ?? 0} icon={<ListIcon size={15} />} tone="warning" />
        </div>
      </div>
