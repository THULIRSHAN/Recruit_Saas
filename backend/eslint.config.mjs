...
export default tseslint.config(
  ...
  {
    // e2e/unit test assertions routinely touch untyped response bodies
    // (supertest's Response.body is `any`) — relax the typed-linting rules
    // there rather than casting in every test.
